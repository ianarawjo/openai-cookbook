...
- [ChainForge](https://github.com/ianarawjo/ChainForge): An open-source visual environment for testing and comparing prompts and models, set up for rapid-fire iteration. 
